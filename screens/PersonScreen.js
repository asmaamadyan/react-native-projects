...
import { fallbackPersonImage, fetchPersonDetails, fetchPersonMovies, image342 } from '../api/movieedb';
...
export default function PersonScreen() {
  ...
  return (
    <ScrollView className = " flex-1 bg-neutral-900 contentContainerStyle={{paddingBottom :20}}">
      ...
      <SafeAreaView
          className={
            " z-20 w-full flex-row justify-between item-center px-4 " +
            verticalMargin
          }>
          <TouchableOpacity
...
<View>
        ...
        style = {{
          ...
          <View className = "item-center rounded-full overflow-hidden h-72 border-2 border-neutral-500">
          ...
          <View className = "mx-4 my-6 space-y-2">
            ...
            <Text className ="text-neutral-400 ttracking-wide">{person?.biography}</Text>
          </View>
          {/* Movie list */}
